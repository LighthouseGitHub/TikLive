/system script
add dont-require-permissions=no name="SFTP BACKUP" owner=admin policy=ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="/log info \"Lighthouse Mikrotik backup\"\r\
    ...
    \n/tool fetch url=\"sftp://mikrotikbackups.lighthouseit.us/\$rName/\$rName.rsc\" user=\"TIKup\" password=\"\$tatooine\" src-path=\"export.rsc\" dst-path=\"\$rName\\backup\" upload=yes\r\
