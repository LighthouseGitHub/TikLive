...
add bridge=bridge-local ingress-filtering=no interface=ether11
add bridge=bridge-local ingress-filtering=no interface=ether12
add bridge=bridge-local ingress-filtering=no interface=ether13
